    ...
    public Notification getPersistentNotification(int id) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            builder.setSmallIcon(icon).setTicker(tickerText)
                    .setWhen(when).setContentTitle(contentTitle)
            ...
            try {
                Method deprecatedMethod = notification.getClass()
                        .getMethod("setLatestEventInfo", Context.class,
                                CharSequence.class, CharSequence.class, PendingIntent.class);
                deprecatedMethod.invoke(notification, c, contentTitle, null, contentIntent);
